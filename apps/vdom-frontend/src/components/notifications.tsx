  ...
  const renderPopupContent = () => (
    ...
    >
      <div class="oj-panel-header oj-sm-padding-4x-bottom" style={{ position: 'sticky', top: 0, zIndex: 2, background: 'inherit', width: '100%' }}>
        <h3 class="oj-sm-padding-4x-horizontal oj-typography-heading-md oj-panel-title" style={{ width: '100%' }}>Alerts ({unreadCount} unresolved)</h3>
      </div>
      <div class="oj-panel-body oj-sm-padding-0" style={{ overflowY: 'auto', width: '100%' }}>
        {loading ? (
          ...
          <div class="oj-sm-padding-4x oj-sm-text-align-center">
            <span class="oj-typography-body-md oj-text-color-secondary">You're all caught up! No alerts at the moment.</span>
          </div>
        ) : (
